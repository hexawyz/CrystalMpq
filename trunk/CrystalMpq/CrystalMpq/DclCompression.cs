...
namespace CrystalMpq
{
	static class DclCompression
	{
		...
		static readonly byte[] offsetCodeLength = new byte[]
		{
		...
		static readonly byte[] offsetCode = new byte[]
		{
		...
		static readonly short[] lengthBase = new short[]
		{
			0x0000, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007,
			0x0008, 0x000A, 0x000E, 0x0016, 0x0026, 0x0046, 0x0086, 0x0106
		};
		static readonly byte[] lengthUpperCodeLength = new byte[]
		{
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08
		};
		static readonly byte[] lengthLowerCodeLength = new byte[]
		{
			0x03, 0x02, 0x03, 0x03, 0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07
		};
		static readonly byte[] lengthLowerCode = new byte[]
		{
			0x05, 0x03, 0x01, 0x06, 0x0A, 0x02, 0x0C, 0x14, 0x04, 0x18, 0x08, 0x30, 0x10, 0x20, 0x40, 0x00
		};
		static readonly byte[] asciiCodeLength = new byte[]
		{
		...
		static readonly short[] asciiCode = new short[]
		{
